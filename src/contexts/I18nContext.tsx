...
const translations: Record<Language, TranslationDictionary> = {
  en: {
    ...
    group: {
      ...
      linkUserDescription: 'Link "{{name}}" to a registered user. Their stats will be merged and the guest entry will be removed.',
  ...
  it: {
    ...
    group: {
      ...
      linkUserDescription: 'Collega "{{name}}" a un utente registrato. Le statistiche verranno unite e l\'ospite verrà rimosso.',
